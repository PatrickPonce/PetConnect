...
namespace PetConnect.Migrations
{
    ...
    [Migration("20251025183501_AgregadoEntidadesPetShop")]
    partial class AgregadoEntidadesPetShop
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetConnect.Models.ComentarioPetShop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PetConnect.Models.FavoritoPetShop", b =>
                {
                    b.Property<int>("PetShopId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("PetShopId", "UsuarioId");

                    b.HasIndex("UsuarioId");

                    b.ToTable("FavoritosPetShop");
                });
            ...
            modelBuilder.Entity("PetConnect.Models.PetShop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("MarcasPrincipales")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PetConnect.Models.ComentarioPetShop", b =>
                {
                    b.HasOne("PetConnect.Models.PetShop", "PetShop")
                        .WithMany("Comentarios")
