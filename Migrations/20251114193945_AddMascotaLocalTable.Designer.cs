...
namespace PetConnect.Migrations
{
    ...
    [Migration("20251114193945_AddMascotaLocalTable")]
    partial class AddMascotaLocalTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetConnect.Models.ComentarioGuarderia", b =>
                {
                    ...
                    b.ToTable("ComentariosGuarderia");
                });
            ...
            modelBuilder.Entity("PetConnect.Models.FavoritoGuarderia", b =>
                {
                    ...
                    b.HasKey("GuarderiaId", "UsuarioId");

                    b.HasIndex("UsuarioId");

                    b.ToTable("FavoritosGuarderia");
                });
            ...
            modelBuilder.Entity("PetConnect.Models.FavoritoLugar", b =>
                {
                    ...
                    b.HasKey("LugarPetFriendlyId", "UsuarioId");
            ...
            modelBuilder.Entity("PetConnect.Models.FavoritoProducto", b =>
                {
                    ...
                    b.HasKey("ProductoPetShopId", "UsuarioId");

                    b.HasIndex("UsuarioId");

                    b.ToTable("FavoritosProducto");
                });
            ...
            modelBuilder.Entity("PetConnect.Models.FavoritoServicio", b =>
                {
                    ...
                    b.ToTable("FavoritosServicio");
                });

            modelBuilder.Entity("PetConnect.Models.Guarderia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PetConnect.Models.GuarderiaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PetConnect.Models.LugarPetFriendlyDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("lugar_pet_friendly_detalles");
                });

            modelBuilder.Entity("PetConnect.Models.Mascota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PetConnect.Models.Pago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PetConnect.Models.FavoritoProducto", b =>
                {
                    b.HasOne("PetConnect.Models.ProductoPetShop", "ProductoPetShop")
                        .WithMany("Favoritos")
            ...
            modelBuilder.Entity("PetConnect.Models.GuarderiaDetalle", b =>
                {
                    b.HasOne("PetConnect.Models.Servicio", "Servicio")
                        .WithOne("GuarderiaDetalle")
                        .HasForeignKey("PetConnect.Models.GuarderiaDetalle", "ServicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PetConnect.Models.LugarPetFriendlyDetalle", b =>
                {
                    b.HasOne("PetConnect.Models.Servicio", "Servicio")
                        .WithOne("LugarPetFriendlyDetalle")
                        .HasForeignKey("PetConnect.Models.LugarPetFriendlyDetalle", "ServicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PetConnect.Models.Servicio", b =>
                {
                    ...
                    b.Navigation("GuarderiaDetalle");

                    b.Navigation("LugarPetFriendlyDetalle");
