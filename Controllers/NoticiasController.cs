    ...
    public IActionResult Index()
    {
        var noticias = new List<Noticia>
        {
            new Noticia
            {
                ...
                Contenido = "El gato persa es, sin duda, uno de los gatos más emblemáticos y queridos del mundo. Su presencia...",
                UrlImagen = "https://gatos.plus/wp-content/uploads/2020/05/gato-persa.jpg",
                FechaPublicacion = new DateTime(2025, 8, 21),
                Comentarios = new List<Comentario>
                {
                    new Comentario { Autor = "David Gor", Texto = "Holaa", FechaComentario = DateTime.Now.AddMinutes(-5) },
                    new Comentario { Autor = "David Gor", Texto = "Los gatos persa son muy bonitos >.<", FechaComentario = DateTime.Now.AddMinutes(-2) }
                }
            },
            new Noticia
            {
                ...
                Contenido = "Si tienes un gato en casa, seguramente te has preguntado más de una vez: ¿Por qué duerme...",
            ...
            new Noticia
            {
                ...
                Contenido = "Las olas comienzan a formarse en el horizonte, y de repente, una tabla corta el agua con...",
...
<p>El gato persa es perfecto para personas que buscan un compañero tranquilo  y de carácter apacible. Son afectuosos, toleran bien la soledad moderada y aprecian un entorno relajado. No son la mejor opción para hogares con niños muy enérgicos o ambientes caóticos.

También son propensos al sobrepeso si no tienen una dieta controlada y algo de juego diario. Pocos minutos de interacción pueden asegurar su salud física y mental. El gato persa se distingue por su temperamento apacible, cariño y elegancia.</p>
",
